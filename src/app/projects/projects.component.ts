...
export class ProjectsComponent implements AfterViewInit {
  ...
  projects = [
  {
    ...
    features: [
      ...
      'Evaluación clínica del motivo de consulta e identificación de dinámicas que generan el problema',
